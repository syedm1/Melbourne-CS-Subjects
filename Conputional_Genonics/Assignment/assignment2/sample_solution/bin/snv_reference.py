...
from snv_caller.caller_strategies import SubReference, ReferenceStrategy
...
parser.add_argument('--outfile', type=argparse.FileType('w'), default=open('snvs.vcf', 'w'),
                    help='the called snvs ( Default snvs.vcf )')
...
if args.reference_file:
  reference = SubReference(args.reference_file)
  caller_strategy = ReferenceStrategy(reference)
