...
\begin{figure}[!htb]
	\centering
	\subfigure[Time consuming as reference length.]{
		\label{a1} 
		\includegraphics[width=0.5\textwidth]{time_ref_len.png}}
	\subfigure[All mismatches]{
		\label{bb} 
		\includegraphics[width=0.5\textwidth]{mis_qs.png}}
	\subfigure[TIme consuming visulation of fixed k]{
		\label{cc} 
		\includegraphics[width=0.5\textwidth]{align_vis.pdf}}
